...
void run_yolt(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "train")) train_yolt(cfg, weights, train_images, results_dir, nbands, loss_file);
    else if(0==strcmp(argv[2], "valid")) validate_yolt(cfg, weights, valid_image, valid_list_loc, 
